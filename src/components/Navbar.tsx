  ...
  return (
    <motion.header
      ...
      className={`fixed inset-x-0 top-0 z-50 transition-all duration-500 ${
        scrolled ? 'bg-ink/80 backdrop-blur-md border-b border-bone/10' : 'bg-transparent'
      }`}
    >
      <div className="mx-auto flex max-w-[1500px] items-center justify-between px-5 py-4 md:px-10 md:py-5">
        ...
        <div className="flex items-center gap-5">
          ...
          <a
            href="#process"
            data-hover
            className="group relative overflow-hidden rounded-full border border-bone/20 px-6 py-2.5 font-mono text-[11px] font-semibold tracking-[0.25em] text-bone uppercase transition-colors duration-300 hover:border-gold hover:text-gold"
          >
            Apply now
          </a>
          <button
